declare global {
  ...
  const gameEngine: typeof import('../../server/utils/gameEngine').gameEngine
...
declare global {
  ...
  // @ts-ignore
  export type { PlayerData, SpectatorData, RoomData } from '../../server/utils/database'
  import('../../server/utils/database')
  // @ts-ignore
  export type { WolfData, SpyData, GameState } from '../../server/utils/gameEngine'
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from 'C:/Users/owner/Desktop/開発フォルダ/werewolf-death/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from 'C:/Users/owner/Desktop/開発フォルダ/werewolf-death/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { db } from 'C:/Users/owner/Desktop/開発フォルダ/werewolf-death/server/utils/database';
export { gameEngine } from 'C:/Users/owner/Desktop/開発フォルダ/werewolf-death/server/utils/gameEngine';